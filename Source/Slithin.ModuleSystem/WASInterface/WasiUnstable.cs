...
namespace Slithin.ModuleSystem.WASInterface
{
    public static partial class WasiUnstable
    {
        ...
        private static Dictionary<int, FilePair> _files = new Dictionary<int, FilePair>();
        ...
        {
            var path = Util.FromUtf8(Sg_wasm.__mem + addr_path, path_len);
            throw new NotImplementedException();
        }
        ...
        {
            var old_path = Util.FromUtf8(Sg_wasm.__mem + addr_old_path, old_path_len);
            var new_path = Util.FromUtf8(Sg_wasm.__mem + addr_new_path, new_path_len);
            throw new NotImplementedException();
        }
